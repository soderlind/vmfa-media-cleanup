...
- WP 7.0+ design-token style overrides for scan, results, duplicate, and settings panels
...
- Added Node.js build step to GitHub Actions release workflows (zip was missing JS/CSS assets)
- Added build/index.js verification check to release workflows
